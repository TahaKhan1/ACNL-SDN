...
class Backup_Paths():
    ...
    def __init__(self, msg, link_ids, datapath_list):
        ...
        self.primary_flows = {1: (datapath_list[1], '10.0.0.1', '10.0.0.2', 3, 1),
                              ...
                              9: (datapath_list[1], '10.0.0.1', '10.0.0.2', 3, 2),
                              10: (datapath_list[1], '10.0.0.2', '10.0.0.1', 2, 3),
                              11: (datapath_list[5], '10.0.0.1', '10.0.0.2', 2, 1),
                              12: (datapath_list[5], '10.0.0.2', '10.0.0.1', 1, 2),
                              13: (datapath_list[6], '10.0.0.1', '10.0.0.2', 2, 1),
                              14: (datapath_list[6], '10.0.0.2', '10.0.0.1', 1, 2),
                              15: (datapath_list[4], '10.0.0.1', '10.0.0.2', 2, 3),
                              16: (datapath_list[4], '10.0.0.2', '10.0.0.1', 3, 2)
                              }
